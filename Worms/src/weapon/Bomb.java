...
/**
 * Weapon which is dropped from above
 */
public class Bomb extends Weapon{
	 ...
	 * @throws IOException
	 */
	public Bomb(String name, int dmg, int expl, int range, String desc, Point p) throws IOException {
		super(name, dmg, expl, range, desc, p, ImageIO.read(new File("gun3.png")));
	}
